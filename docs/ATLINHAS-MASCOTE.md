...
O teste do mascote agora mede a distância entre a ponta e a âncora do personagem após alternar cards, abrir consultas e avançar no tutorial; também verifica os novos gestos e o modo de movimento reduzido. TypeScript e compilação local aprovados. No Mac de Lucas, em 14/09/2026 às 15:07:35 de Brasília (18:07:35 UTC), os **12 cenários do assistente passaram**, sem falhas, instáveis ou ignorados, em 44,8 segundos. Código: `6e0d5e2be38c40b364742e507857a22a4a527c53`; ambiente darwin 25.6.0 / Node v24.21.0. [Resultado e capturas](https://github.com/lucasgarciamoreira92-rgb/atlaslinhas-validacao-mac/actions/runs/34878726884). A execução usou uma cópia temporária; a aplicação diária precisa receber a atualização pelo procedimento de instalação existente.
